 ...
 */
package com.group1.task4.part2.appLauncher;
...
import com.group1.task3.part1.guioptimiser.EnergyConsumptionComputer;
...
//                }
        ...
        System.out.println("Total charge consumption: " + totalChargeConsumption);
    ...
    public static void changeColorAll(ArrayList<ArrayList<Integer>> RGB) {
        try {
            ...
            saveToCSV(parentDir.concat("src/main/java/com/group1/task4/part2/referenceScheme/calculatorColourScheme/")
