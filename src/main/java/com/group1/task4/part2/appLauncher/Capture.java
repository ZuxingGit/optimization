...
public class Capture {
    ...
    public Capture(String targetApp) {
        ...
        if (targetApp.contains("SimpleMainFrame")) {
            this.path = "src/main/java/com/group1/task4/part2/outcomes/simpleApp/";
        } else if (targetApp.contains("CalculatorMainFrame")) {
            this.path = "src/main/java/com/group1/task4/part2/outcomes/calculator/";
        } else {
            this.path = "src/main/java/com/group1/task4/part2/outcomes/";
        }
    }
